...
namespace sxml
{
  ...
  void
  sounds (::std::ostream& os,
          const ::sxml::SoundsXML& x, 
  ...
  void
  sounds (::xercesc::XMLFormatTarget& ft,
          const ::sxml::SoundsXML& x, 
          const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
          const ::std::string& e = "UTF-8",
          ::xml_schema::flags f = 0);
  ...
  sounds (const ::sxml::SoundsXML& x, 
          const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
          ::xml_schema::flags f = 0);

  void
  operator<< (::xercesc::DOMElement&, const SoundsXML&);
