...
namespace rxml
{
  class RoomXML: public ::xml_schema::type
  {
    ...
    RoomXML (const name_type&,
             ...
             const width_type&,
             const floorType_type&,
             ::std::auto_ptr< floor_type >,
             ::std::auto_ptr< items_type >);
  ...
  class triple_room_data: public ::xml_schema::type
  {
    ...
    triple_room_data (::std::auto_ptr< bound_x_type >,
                      ::std::auto_ptr< bound_y_type >);
...
namespace rxml
{
  ...
  void
  room (::xercesc::XMLFormatTarget& ft,
        const ::rxml::RoomXML& x, 
        const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
        const ::std::string& e = "UTF-8",
        ::xml_schema::flags f = 0);
  ...
  room (const ::rxml::RoomXML& x, 
        const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
        ::xml_schema::flags f = 0);

  void
  operator<< (::xercesc::DOMElement&, const RoomXML&);

  void
  operator<< (::xercesc::DOMElement&, const floorType&);

  void
  operator<< (::xercesc::DOMAttr&, const floorType&);
  ...
  void
  operator<< (::xercesc::DOMElement&, const triple_room_data&);

  void
  operator<< (::xercesc::DOMElement&, const floor&);

  void
  operator<< (::xercesc::DOMElement&, const walls&);

  void
  operator<< (::xercesc::DOMElement&, const items&);

  void
  operator<< (::xercesc::DOMElement&, const northeast&);

  void
  operator<< (::xercesc::DOMElement&, const southeast&);

  void
  operator<< (::xercesc::DOMElement&, const northwest&);

  void
  operator<< (::xercesc::DOMElement&, const southwest&);

  void
  operator<< (::xercesc::DOMElement&, const eastnorth&);

  void
  operator<< (::xercesc::DOMElement&, const eastsouth&);

  void
  operator<< (::xercesc::DOMElement&, const westnorth&);

  void
  operator<< (::xercesc::DOMElement&, const westsouth&);

  void
  operator<< (::xercesc::DOMElement&, const bound_x&);

  void
  operator<< (::xercesc::DOMElement&, const bound_y&);

  void
  operator<< (::xercesc::DOMElement&, const tile&);
  ...
  void
  operator<< (::xercesc::DOMAttr&, const axis&);
